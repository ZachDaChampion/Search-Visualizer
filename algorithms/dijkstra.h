...
class Dijkstra : public SearchAlgorithm {
   ...
   */
  Dijkstra(std::shared_ptr<Grid> grid, const std::shared_ptr<Grid::Cell> start,
  ...
  /**
   * Step through the Dijkstra algorithm.
